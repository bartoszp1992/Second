...
v_check = 300; //(us) 2000 single, 350 for serial(for 100uF cap) checking load voltages- time for discharge cell capacitor
...
max_v_dcr = 950;//default: 650 for short protection- voltage decrease at max battery current
//@up
