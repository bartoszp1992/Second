 ...
 *	Ver 1.1.5
 *	-fixed freezes
 *	-anti short on each cycle
 *	-pwm working only in warming mode
 */
...
int main(void)
{
		...
		//times
		int t_warm, t_blink, t_splash, t_press, t_pause, v_check, t_adj_s, t_adj_f, v_display, t_preheat, t_unlock;
