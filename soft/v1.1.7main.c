...
//define ports
	...
	PORTD = 0x00; // 0000 0000 all D low
...
//splash
PORTC |= (1<<stb);
PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4) | (1<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4) | (0<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4) | (0<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
_delay_ms(t_splash);
PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
_delay_ms(t_splash);
PORTC = 0x07;
...
while(voltage < low_voltage )
	...
	PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
	_delay_ms(t_blink);
	PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
	_delay_ms(t_blink);
	PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
	_delay_ms(t_blink);
	PORTD = (1<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
...
if (!(PINC & fire) && !(PINC & minus) && (PINC & plus) && (menu_toggle == 0))
	...
	menu_toggle = 1;
	opt = 4;
	PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (0<<ind2) | (1<<ind3) |(1<<ind4) | (0<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
	_delay_ms(t_splash);
	}
...
while(menu_toggle == 1)
	...
	if ( opt == 1 ) PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) | (0<<ind4);
	if ( opt == 2 ) PORTD = (0<<ind1) | (1<<ind2) | (0<<ind3) | (0<<ind4);
	if ( opt == 3 ) PORTD = (0<<ind1) | (0<<ind2) | (1<<ind3) | (0<<ind4);
	if ( opt == 4 ) PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) | (1<<ind4);
	...
	if ((opt == 2) && !(PINC & fire) && (PINC & minus))
		...
		while(pha == 1)
			{
			if ( phd < ds1 ) PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
			if ( phd >= ds1 ) PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
			if ( phd >= ds2 ) PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
			if ( phd >= ds3 ) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4);
			if ( phd >= ds4 ) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
		...
		while(tpha == 1)
			...
			if ( tph == 1 ) PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
			if ( tph == 2 ) PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
			if ( tph == 3 ) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4);
			if ( tph == 4 ) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
...
//opt3 normal
	...
	if ((opt == 4) && !(PINC & fire) && (PINC & minus) && (lock == 0))
		...
		if (lock == 1)
			...
			PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4) | (1<<buz);
			_delay_ms(t_splash);
			PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4);
			_delay_ms(t_splash);
			PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
			_delay_ms(t_splash);
			PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
			_delay_ms(t_splash);
			PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
...
while(!(PINC & plus) && (PINC & minus) && (PINC & fire) && (duty < 255 - step) && (mode != 2))
	...
	if(counter < adj_counter)
		...
		if ( duty < ds1 ) PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
		if ( duty >= ds1 ) PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
		if ( duty >= ds2 ) PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
		if ( duty >= ds3 ) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4);
		if ( duty >= ds4 ) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
		}
	//fast mode
	if(counter >= adj_counter)
		{
...
if(!(PINC & minus) && !(PINC & plus)) //minus and plus
	...
	PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) | (0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (1<<ind2) | (0<<ind3) | (0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (0<<ind2) | (1<<ind3) | (0<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) | (1<<ind4) | (1<<buz);
	_delay_ms(t_splash);
	PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) | (0<<ind4) | (1<<buz);
	...
	//voltage indicator
	if (voltage < vs1) PORTD = (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
	if (voltage >= vs1) PORTD = (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
	if (voltage >= vs2) PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
	if (voltage >= vs3) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4);
	if (voltage >= vs4) PORTD = (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
...
if ((duty < ds1) && (mode != 2) && (lock == 0)) PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
if ((duty >= ds1) && (mode != 2) && (lock == 0)) PORTD = (0<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
if ((duty >= ds2) && (mode != 2) && (lock == 0)) PORTD = (0<<warm) | (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
if ((duty >= ds3) && (mode != 2) && (lock == 0)) PORTD = (0<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(0<<ind4);
if ((duty >= ds4) && (mode != 2) && (lock == 0)) PORTD = (0<<warm) | (1<<ind1) | (1<<ind2) | (1<<ind3) |(1<<ind4);
...
while(!(PINC & fire) && (PINC & minus) && (PINC & plus))
	...
	while(v_dcr >= max_v_dcr && !(PINC & fire) && (PINC & minus) && (PINC & plus))
		{
		OCR1A = 0;
		PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
		_delay_ms(t_blink);
		PORTD = (1<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (1<<buz);
		_delay_ms(t_blink);
		PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
		_delay_ms(t_blink);
		PORTD = (1<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (1<<buz);
		...
		PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
		_delay_ms(t_blink);
		PORTD = (1<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (0<<buz);
		_delay_ms(t_blink);
	...
	while(v_dcr < min_v_dcr && !(PINC & fire) && (PINC & minus) && (PINC & plus))
		...
		PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
		_delay_ms(t_blink);
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (0<<buz);
		_delay_ms(t_blink);
		PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (1<<buz);
		_delay_ms(t_blink);
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (0<<buz);
		...
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (0<<buz);
		_delay_ms(t_blink);
		PORTD = (0<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz);
		_delay_ms(t_blink);
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4) | (0<<buz);
		_delay_ms(t_blink);
	...
	while(v_dcr <= max_v_dcr && l_v >= min_l_v && !(PINC & fire) && (mode == 0) && (PINC & minus) && (PINC & plus))
		{
		OCR1A = duty;
		PORTD = (1<<warm) | (1<<ind1) | (0<<ind2) | (0<<ind3) |(0<<ind4);
		_delay_ms(t_warm);
		PORTD = (1<<warm) | (0<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
		_delay_ms(t_warm);
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (1<<ind3) |(0<<ind4);
		_delay_ms(t_warm);
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (0<<ind3) |(1<<ind4);
		_delay_ms(t_warm);
		PORTD = (1<<warm) | (0<<ind1) | (0<<ind2) | (1<<ind3) |(0<<ind4);
		_delay_ms(t_warm);
		PORTD = (1<<warm) | (0<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4);
