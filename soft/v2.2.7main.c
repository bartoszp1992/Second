...
int t_warm2, cal, cell_ind, cell_ind_rst, amp1, amp2, amp3, amp4, amp5, amp6, amp7, amp8, amp9, amp10, amp11, amp12, amp13, amp14, amp15;
amp1 = 2000;
amp2 = 4000;
amp3 = 6000;
amp4 = 8000;
...
while (cal == 1)
	...
	if ((PINC & fire) && (PINC & minus) && !(PINC & plus) && (cell_ind < 45))
		{
...
//minus
	if ((PINC & fire) && !(PINC & minus) && (PINC & plus) && (cell_ind > 25))
		{
		PORTD = (1<<ind1) | (1<<ind2) | (0<<ind3) |(0<<ind4) | (0<<buz) | (1<<bl);
		cell_ind = cell_ind - 1;
		_delay_ms(t_press);
